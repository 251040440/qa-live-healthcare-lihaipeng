-- 初始化医生用户数据
-- 从 web/qa-web/src/data/doctor-user-list.json 转换而来
...
-- 插入医生用户数据
INSERT INTO doctor_users (id, username, password, name, title, department, avatar, experience, is_active) VALUES
